package com.nicholasjacquet.payroll;

// The basic rule for creating JavaDoc comments 
// is that they begin with /** and they end with */

/** Represents an employee 
 * @author Nicholas Jacquet
 * @author www.nicholasjacquet.com
 * @version 1.5
 * @since 1.0
 */
public class Employee
{
	 ...
	 * @param firstName A String containing the employee's fist name.
	 */
